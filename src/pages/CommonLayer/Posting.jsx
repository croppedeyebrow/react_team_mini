...
const Posting = () => {
    ...
    return (
        <>
            ...
            <PostingContainer>
            <Posting1>
                <PostingImg><ImgIcon alt="사진 아이콘" src={gallery}></ImgIcon></PostingImg>
                <PostingVid><VidIcon alt="동영상 아이콘" src={video}></VidIcon></PostingVid>
                <PostingLoc><LocIcon alt="위치 아이콘" src={location}></LocIcon></PostingLoc>
            </Posting1>
            <Posting2>
                <Title>
                    게시판 글쓰기
                </Title>
                <TitlePosting placeholder='제목을 입력하세요'>
                </TitlePosting>
                <div>
                    <App></App>
                </div>
